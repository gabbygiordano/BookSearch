...
public class BookDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(ivBookCover.getContext()).load(book.getCoverUrl()).into(ivBookCover);


        ImageView ivImage = (ImageView) findViewById(R.id.ivBookCover);
        // Load image async from remote URL, setup share when completed
        Glide.with(this).load(book.getCoverUrl()).listener(new RequestListener<String, GlideDrawable>() {
                    @Override
